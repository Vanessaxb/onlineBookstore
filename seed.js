...
(async function() {
  ...
  const categories = await Category.create([
    {name: 'Biography', sortOrder:10},
    {name: 'Fiction', sortOrder: 20},
    {name: 'Romance', sortOrder:30},
    {name: 'History', sortOrder: 40},
    {name: 'Kids', sortOrder: 50},
    {name: 'Arts', sortOrder: 60},
    {name: 'Suspence', sortOrder: 70},    
  ]);
